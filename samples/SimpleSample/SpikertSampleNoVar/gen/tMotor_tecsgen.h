...
/* attr access  #_AAM_# */
#define tMotor_ATTR_motor_ref( p_that )	((p_that)->motor_ref)

#define tMotor_GET_motor_ref(p_that)	((p_that)->motor_ref)
...
#define ATTR_motor_ref       tMotor_ATTR_motor_ref( p_cellcb )
...
#undef ATTR_motor_ref
#undef tMotor_ATTR_motor_ref
#undef tMotor_GET_motor_ref
