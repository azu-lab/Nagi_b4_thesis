...
typedef const struct tag_tSensor_INIB {
    ...
    /* call port #_NEP_# */ 
    /* attribute(RO) #_ATO_# */ 
    pup_ultrasonic_sensor_t ult_ref;
}  tSensor_INIB;

/* CB not exist. CB corresponding to INIB #_DCI_# */
#define tSensor_CB_tab           tSensor_INIB_tab
#define tSensor_CB               tSensor_INIB
#define tag_tSensor_CB           tag_tSensor_INIB

/* singleton cell CB prototype declaration #_MCPB_# */
extern tSensor_INIB  tSensor_INIB_tab[];

/* celltype IDX type #_CTIX_# */
typedef const struct tag_tSensor_INIB *tSensor_IDX;
...
/* attr access  #_AAM_# */
#define tSensor_ATTR_ult_ref( p_that )	((p_that)->ult_ref)

#define tSensor_GET_ult_ref(p_that)	((p_that)->ult_ref)
...
#define ATTR_ult_ref         tSensor_ATTR_ult_ref( p_cellcb )
...
#undef ATTR_ult_ref
#undef tSensor_ATTR_ult_ref
#undef tSensor_GET_ult_ref
